...
class BubbleTrashLayout extends BubbleBaseLayout {
        ...
        if (attachedToWindow) {
            if (visibility != getVisibility()) {
                if (visibility == VISIBLE) {
                    playAnimation(getIconResId("bubble_trash_shown_animator","animator"));


                } else {
                    playAnimation(getIconResId("bubble_trash_hide_animator","animator"));
                }
            }
        }
    ...
    void applyMagnetism() {
        if (!magnetismApplied) {
            ...
            playAnimation(getIconResId("bubble_trash_shown_magnetism_animator","animator"));
        }
    }
    ...
    void releaseMagnetism() {
        if (magnetismApplied) {
            ...
            playAnimation(getIconResId("bubble_trash_hide_magnetism_animator","animator"));
        }
