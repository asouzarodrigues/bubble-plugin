...
public class BubbleLayout extends BubbleBaseLayout {
    ...
    private void playAnimation() {
        if (!isInEditMode()) {
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
                    .loadAnimator(getContext(), getIconResId("bubble_shown_animator","animator"));
    ...
    private void playAnimationClickDown() {
        if (!isInEditMode()) {
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
                    .loadAnimator(getContext(), getIconResId("bubble_down_click_animator","animator"));
            animator.setTarget(this);
            animator.start();
        }
    }
    ...
    private void playAnimationClickUp() {
        if (!isInEditMode()) {
            AnimatorSet animator = (AnimatorSet) AnimatorInflater
                    .loadAnimator(getContext(), getIconResId("bubble_up_click_animator","animator"));
            animator.setTarget(this);
            animator.start();
        }
    }
